...
def cython_identify(bayes_deanonymize, genome, actual_node,
                    ibd_threshold = 5000000):
    node_probabilities = dict() # Probability that a node is a match
    id_map = bayes_deanonymize._population.id_mapping
    length_classifier = bayes_deanonymize._length_classifier
    shared_list = []
